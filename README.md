...
| 04 | Claude Code 深度功能 | Hooks、MCP、自定义 Skills、权限设置 |
| 05 | 工作流设计 | 多 Agent 工作流、任务分解、验证点设计 |
| 06 | 常用 AI 工作流 | Deep Research、Plan & Execute、Skeleton First、STORM |
| 07 | AI 辅助编程专题 | Spec-driven、TDD with AI、大型代码库、Code Review |
...
├── 01-mental-models/notes.md
├── 02-prompt-engineering/
│   ├── notes.md
│   └── examples/rctf-templates.md  ← 可直接使用的模板
├── 03-context-engineering/notes.md
├── 04-claude-code-features/notes.md
├── 05-workflow-design/notes.md
├── 06-ai-workflows/notes.md
└── 07-ai-coding/notes.md
```
